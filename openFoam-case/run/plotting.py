...
import matplotlib
# This is required to 'plot' inside the CLI (or some SSH type connection)
matplotlib.use('AGG')
...
# Values taken from the python terminal calling with the route and name of the file
route = sys.argv[1]
file = sys.argv[2]

# Examples blocks to parse the values (2 are taken from this solver and turbulence model)
exampleLine1 = "Time = {}\n\
\n\
...
# Parameters to make plotting automatic (first figure)
elementsPlot1 = [1,4,7,13,19]
confPlot1 = ['r','g','y','b','orange']
legendPlot1 = [r'$U_x$',r'$U_y$',r'$\varepsilon$',r'$k$',r'$p$']

# Parameters to make plotting automatic (second figure)
elementsPlot2 = [11,12]
confPlot2 = ['g','r']
legendPlot2 = ['Global','Cumulative']

# Parameters to make plotting automatic (third figure)
